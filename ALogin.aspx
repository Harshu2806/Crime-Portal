 ...
 <center> <h1>Admin Login</h1> </center> <br/>
      ...
      <%--<input id="email" type="text" class="form-control" name="email" placeholder="Email">--%>
       <%-- <asp:Label ID="Label1" runat="server" Text="Label">Email:</asp:Label>
        ...
        <asp:TextBox ID="TextBox1" runat="server" class="form-control" 
            placeholder="Username / Email" TextMode="SingleLine" ></asp:TextBox>
  ...
  <div class="text-center mt-5">
    ...
    <p><asp:LinkButton ID="LinkButton1" runat="server" 
        PostBackUrl="~/AForgotPassword.aspx" ForeColor="#000080">Forgot Password?</asp:LinkButton>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:LinkButton ID="LinkButton2" runat="server" ForeColor="#000080" PostBackUrl="~/Login.aspx">User Login</asp:LinkButton>
      </p>
</div><br>
