<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AForgotPassword.aspx.cs" Inherits="AForgotPassword" %>
...
&nbsp;
    ...
    <br />
    <br />
    <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/ALogin.aspx">LogIn</asp:LinkButton>
</center>
</asp:Content>
